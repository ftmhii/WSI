document.addEventListener("DOMContentLoaded", () => {
    ...
    const updateVisibility = () => {
        ...
        // Content writing pages input is always visible for WordPress now
        ...
        contentPagesInput.value = 0; // Reset content pages to 0
    ...
    contentPagesInput.addEventListener("input", calculatePrice); // Ensure price recalculates when content pages input changes
